@extends('template_pastoral',['title'=>"Pastoral de Cerimoniários e Coroinhas"])
@section('conteudo')
		<h1 id="conteudo">Cerimoniários e Coroinhas</h1>
<p class="text-justify">A missão da Catequese é fazer ecoar a Palavra de Deus. A catequese está presente em todas as idades e deve ser uma trajetória contínua de educação na fé. 
