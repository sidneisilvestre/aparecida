...
<li><a href="#rodape" accesskey="2">ir para o Rodapé</a></li>
		<li><a href="{{ route('home.index') "rodape"}}">Inicio</a>		</li>
		<li><a href="{{ route('home.create') }}">Palavra do Padre</a>		</li>
		<li><a href="{{ route('home.store') }}">Você Sabia</a>		</li>
				<li><a href="{{ route('home.index') }}">Paroquiano do mês</a>		</li>
		<li><a href="{{ route('home.index') }}">Festas do mês </a>		</li>
